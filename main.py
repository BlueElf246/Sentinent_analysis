...
kwargs={'T': 25.0, "L": 0.01}
theta, theta_0= p1.pegasos(train_bow_features, train_labels, 25.0, 0.01)
predict= p1.classify(test_bow_features, theta, theta_0)
print(p1.accuracy(predict, test_labels))
